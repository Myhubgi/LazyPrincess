...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Hey Bro ! Please check your spelling once again 🤦‍♀️... or \n Ask To Your Admin @Mubi369 ")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("Hey Bro ! Please check your spelling once again 🤦‍♀️... or \n Ask To Your Admin @Mubi369 ",
                    reply_markup=InlineKeyboardMarkup(btn))
